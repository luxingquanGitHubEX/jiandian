          ...
          <div class="head-right fr">
              ...
              <div class="nav fr">
                  <ul>
                       ...
                       <li class="nav-cut"><a href="active.jsp">活动</a></li>
...
<div class="content">
    ...
    <div class="focus-banner">
           <div class="wrap">
                ...
                <div class="focus-a2">${sessionScope.user.nickname}</div>
               <div class="focus-a3">
    ...
    <div class="focus-b-box">
                <div class="focus-list"><div class="focus-title">${sessionScope.user.nickname}  的文章</div></div>
                <div class="coll-box">
                         <ul class="col-ul">
                              <li>
                                   <div class="col-list">
                                              ...
                                              <div class="col-b fl">
                                                    ...
                                                    <div class="col-b2"><img src="upload/col-b.jpg">${sessionScope.user.nickname}<span>2015-11-02</span></div>
